...
func init() {
	...
	cmdMain.PersistentFlags().StringVar(&globalFlags.VaultCACert, "vault-cacert", "", " 	Path to a PEM-encoded CA cert file to use to verify the Vault server SSL certificate")
	cmdMain.PersistentFlags().StringVar(&globalFlags.VaultCAPath, "vault-capath", "", "Path to a directory of PEM-encoded CA cert files to verify the Vault server SSL certificate")
